...
class New_Survey_Version_Handler_Test extends WP_UnitTestCase {
    ...
    function setUp()
    {
        ...
        $survey_modus_id = $surveys[0]->ID;
        $this->test_modus_survey = \kwps_classes\Test_Modus::get_as_array( $survey_modus_id );
    ...
    function test_new_survey_version_form_validation_Empty() {
        $this->checkOutputWithFormTestData( 'survey/empty.php', false);
    }

    function test_new_survey_version_form_validation_NoIntroIndex() {
        $this->checkOutputWithFormTestData( 'survey/no-intro-index.php');
    }

    function test_new_survey_version_form_validation_NoOutroIndex() {
        $this->checkOutputWithFormTestData( 'survey/no-outro-index.php');
    }

    function test_new_survey_version_form_validation_NoQuestionGroupsIndex() {
        $this->checkOutputWithFormTestData( 'survey/no-question-groups-index.php');
    }

    function test_new_survey_version_form_validation_NoIntroResultIndex() {
        $this->checkOutputWithFormTestData( 'survey/no-intro-result-index.php');
    }

    function test_new_survey_version_form_validation_NotAnArray() {
        $this->checkOutputWithFormTestData( 'survey/not-an-array.php', false);
    }

    function test_new_survey_version_form_validation_valid() {
        $this->checkOutputWithFormTestData( 'survey/valid.php');
    }

//    TODO check if this needs to be validated and how to handle this properly!

//    function test_new_survey_version_form_validation_QuestionWithoutAnswerOptionsIndex() {
//        $this->checkOutputWithFormTestData( 'survey/question-without-answer-options-index.php');
//    }

    function test_new_survey_version_form_validation_QuestionWithOneAnswerOption() {
        $this->checkOutputWithFormTestData( 'survey/question-with-one-answer-option.php');
    }

    function test_new_survey_version_form_validation_QuestionWithEmptyAnswerOptionArray() {
        $this->checkOutputWithFormTestData( 'survey/question-with-empty-answer-option-array.php');
    }
