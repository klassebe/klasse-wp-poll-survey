...
class Result_Profile extends Kwps_Post_Type {
    ...
    public static function get_result_profile_by_version_and_session_hash($version_id, $session_hash){
        $result_profiles = Result_Profile::get_all_by_post_parent( $version_id );

        $current_user_entries =
            Entry::get_all_by_session_hash_and_version($session_hash, $version_id);
